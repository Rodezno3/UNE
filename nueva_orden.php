...
<head>
    ...
    <script>
      ...
      function Redireccion(){
        window.location = 'http://localhost/xoxoctic/nueva_orden.php';
      }
    ...
    $(document).ready(function(){
        ...
        $('#palle').click(function(){
            ...
            if(dely == 0){
                ...
                kod = supcook;
                hud = subcook;
                Cookies.set(supcook , '171' , { expires: 1 , path: '/' });
                Cookies.set(subcook , rip , { expires: 1 , path: '/' });
                kid = rip;
                cook++;
                total = (parseFloat(total) + parseFloat(pir)).toFixed(2);
                $('#tere').val(total);
                $('#prepa').append('<p id="171"><span>'+rip+' Delivery</span> <span> $'+pir+'</span></p>');
                dely = 1;
            } else {
                var fir = 2.50;
                var rif = 1;
                ...
                Cookies.set(kod , 'Delivery' , { expires: -1 , path: '/' });
                Cookies.set(hud , rif , { expires: -1 , path: '/' });
    ...
    <section class="menu_contenedor">
        <form action="php/fun/add_orden.php" method="post">
            <article id="info_cliente">
                ...
                <input type="text" placeholder="%" id="descuento_alterno" name="deal" style="width: 55px; text-align: center;">
                ...
                <label for="llevar" id="palle">Delivery</label>
