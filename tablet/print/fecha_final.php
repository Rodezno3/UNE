...
while($row = $query->fetch(PDO::FETCH_ASSOC)){
    $leng = "SELECT Cantidad, Precio FROM Historial_Orden_T O LEFT JOIN Historial_T H ON O.IDH = H.IDH WHERE Producto=:pro AND Fecha BETWEEN '$year-$numes-01' AND '$year-$numes-$end'";
