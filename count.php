...
<head>
    ...
    <script>
      ...
      function Redireccion(){
        window.location = 'http://localhost/xoxoctic/count.php';
      }
            ...
            <table>
                ...
                if(isset($_POST['mes'])){
                    ...
                    while($xow = $xuery->fetch(PDO::FETCH_ASSOC)){
                        ...
                        //$fan = "SELECT Cantidad, Precio FROM Historial_Orden_C O LEFT JOIN Historial_C H ON O.IDH = H.IDH WHERE Producto=:pro AND Fecha = '2021-7-2'";
